...
import { StackContainer, StackWrapper, StackInfo, StackHeading, StackHouse, StackCard, StackIcon, Icon, StackName, StackImage, LaptopImage } from './StackElements';
                                ...
                                Data.map(item => (
                                    <StackCard key={Math.floor(Math.random() * 1000000)}>
                                        <StackIcon className={item.isLearning}>
                                            <Icon src={`./images/${item.iconPath}.svg`} alt={item.skillName} className="icon" />
                                        </StackIcon>
