...
export const Button = styled(Link)`
  ...
  background: ${({ black }) =>
    black
      ? "#101010"
      : "linear-gradient(90.27deg, #61E87F 3.75%, rgba(132, 244, 177, 0.42) 99.77%)"};
  ...
  padding: ${({ normal_padding }) =>
    normal_padding ? "12px 24px" : "15px 26px"};
  outline: none;
  border: none;
  ...
  align-items: center;
  box-shadow: ${({ animated }) =>
    animated ? "inset 0 0 0 0 rgba(255, 255, 255, 0.6)" : "none"};
  -webkit-tap-highlight-color: transparent;
  transition: all 0.5s cubic-bezier(0.05, 0.33, 0.56, 0.92);

  &:hover {
    box-shadow: ${({ animated }) =>
      animated ? "inset 400px 0 0 0 rgba(255, 255, 255, 0.6)" : "none"};
    color: #101010;
  }
`;
...
export const ButtonNavigate = styled(LinkRouter)`
  ...
  font-size: ${({ slightbig }) => (slightbig ? "20px" : "18px")};
